...
void WifiBoard::StartNetwork() {
    ...
    // Try to connect to WiFi, if failed, reboot into WiFi configuration mode.
    // Rebooting ensures a clean WiFi init (avoids esp_wifi_deinit + esp_wifi_init
    // cycle which can leave the radio in a bad state, preventing AP from broadcasting).
