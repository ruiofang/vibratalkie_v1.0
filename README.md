...
Vibratalkie 小智AI聊天机器人控制板套件，支持 WiFi + 4G 双网络模式。
...
|------|------|------|------|
| 电源键（PEK） | 开机 / 音量- | 4s 关机 | — |
| BOOT 键 | 唤醒/停止对话（启动时切换网络） | — | 切换 AEC 开关 |
| 音量+键 | 音量+10 | 静音 | — |
...
| 摄像头 PWDN | GPIO48 |
| 摄像头 XCLK | GPIO10 |
| 摄像头 D0-D7 | GPIO15, 17, 18, 16, 14, 12, 11, 9 |
| 摄像头 VSYNC | GPIO47 |
| 摄像头 HREF | GPIO21 |
| 摄像头 PCLK | GPIO13 |

> 更多引脚定义请参考 [config.h](config.h)。

#备份固件
/home/phi/.espressif/python_env/idf5.5_py3.10_env/bin/python -m esptool --chip esp32s3 --port /dev/ttyACM0 read_flash 0x0 0x800000 ./firmware_backup.bin
#刷写
source /home/phi/esp/v5.5.2/esp-idf/export.sh
idf.py -p /dev/ttyACM0 erase_flash
/home/phi/.espressif/python_env/idf5.5_py3.10_env/bin/python -m esptool --chip esp32s3 --port /dev/ttyACM0 write_flash 0x0 ./firmware_backup.bin
> [!TIP]
>
